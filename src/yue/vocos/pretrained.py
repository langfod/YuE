...
class Vocos(nn.Module):
    ...
    def from_pretrained(cls, repo_id: str, revision: Optional[str] = None) -> Vocos:
        ...
        """
        config_path = hf_hub_download(repo_id=repo_id, filename="config.yaml", revision=revision, local_dir_use_symlinks=False)
        model_path = hf_hub_download(repo_id=repo_id, filename="pytorch_model.bin", revision=revision, local_dir_use_symlinks=False)
